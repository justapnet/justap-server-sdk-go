...
type CreateRoyaltyRequestRoyaltyReceiver struct {
	...
	FeeModel *CreateRoyaltyRequestRoyaltyFeeMode `json:"fee_model,omitempty"`
	// [OPTIONAL] 手续费比例，与 手续费 字段二选一即可ratio
	FeeRatio float32 `json:"fee_ratio,omitempty"`
	// [OPTIONAL] 根据 royalty_mode 参数，如果 royalty_mode = fixed, 此参数无效，如果 royalty_mode = rate，此参数传分润比例，0.1 表示 10%
	Ratio float32 `json:"ratio,omitempty"`
	// 接受方的商业用户ID
	RecipientBusinessUserId string `json:"recipient_business_user_id,omitempty"`
	// [REQUIRED] 分润模式，free 表示不收取，fixed 表示固定金额，rate 表示按比例分润
	RoyaltyMode *V1RoyaltyMode `json:"royalty_mode,omitempty"`
}
