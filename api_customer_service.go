 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *CustomerServiceApiCustomerServiceUpdateCustomerOpts - Optional Parameters:
     * @param "AppId" (optional.String) - 
     ...
     * @param "Avatar" (optional.String) - 
     * @param "Disabled" (optional.Bool) - 
     * @param "Gender" (optional.String) -   - GENDER_UNKNOWN: 未设置  - MALE: 男  - FE_MALE: 女  - PRIVACY: 保密  - ThirdGender: 第三性别
     * @param "ParentCustomerId" (optional.String) - 
     * @param "OutCustomerId" (optional.String) - 

@return V1CustomerResponse
*/

type CustomerServiceApiCustomerServiceUpdateCustomerOpts struct { 
	AppId optional.String
...
func (a *CustomerServiceApiService) CustomerServiceUpdateCustomer(ctx context.Context, id string, localVarOptionals *CustomerServiceApiCustomerServiceUpdateCustomerOpts) (V1CustomerResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.Avatar.IsSet() {
		localVarQueryParams.Add("avatar", parameterToString(localVarOptionals.Avatar.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Disabled.IsSet() {
		localVarQueryParams.Add("disabled", parameterToString(localVarOptionals.Disabled.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.ParentCustomerId.IsSet() {
		localVarQueryParams.Add("parent_customer_id", parameterToString(localVarOptionals.ParentCustomerId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.OutCustomerId.IsSet() {
		localVarQueryParams.Add("out_customer_id", parameterToString(localVarOptionals.OutCustomerId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/json"}
