...
/*
BusinessUserServiceApiService 删除 BusinessUser 对象
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *BusinessUserServiceApiBusinessUserServiceDeleteUserOpts - Optional Parameters:
...
func (a *BusinessUserServiceApiService) BusinessUserServiceDeleteUser(ctx context.Context, id string, localVarOptionals *BusinessUserServiceApiBusinessUserServiceDeleteUserOpts) (V1DeleteUserResponse, *http.Response, error) {
	var (
...
/*
BusinessUserServiceApiService 查询 BusinessUser 对象列表
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BusinessUserServiceApiBusinessUserServiceListAllUsersOpts - Optional Parameters:
     * @param "AppId" (optional.String) - 
...
func (a *BusinessUserServiceApiService) BusinessUserServiceListAllUsers(ctx context.Context, localVarOptionals *BusinessUserServiceApiBusinessUserServiceListAllUsersOpts) (V1UserListResponse, *http.Response, error) {
	var (
...
/*
BusinessUserServiceApiService 查询 BusinessUser 对象
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *BusinessUserServiceApiBusinessUserServiceRetrieveUserOpts - Optional Parameters:
     * @param "AppId" (optional.String) - 
...
func (a *BusinessUserServiceApiService) BusinessUserServiceRetrieveUser(ctx context.Context, id string, localVarOptionals *BusinessUserServiceApiBusinessUserServiceRetrieveUserOpts) (V1UserResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
BusinessUserServiceApiService 搜索 BusinessUser 对象
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BusinessUserServiceApiBusinessUserServiceSearchUsersOpts - Optional Parameters:
     * @param "AppId" (optional.String) - 
     * @param "Limit" (optional.Int32) -  [OPTIONAL] 限制有多少对象可以被返回，限制范围是从 1~100 项，默认是 10 项
...
func (a *BusinessUserServiceApiService) BusinessUserServiceSearchUsers(ctx context.Context, localVarOptionals *BusinessUserServiceApiBusinessUserServiceSearchUsersOpts) (V1UserListResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
BusinessUserServiceApiService 更新 BusinessUser 对象
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *BusinessUserServiceApiBusinessUserServiceUpdateUserOpts - Optional Parameters:
     * @param "AppId" (optional.String) - 
     ...
     * @param "ParentUserId" (optional.String) - 
...
func (a *BusinessUserServiceApiService) BusinessUserServiceUpdateUser(ctx context.Context, id string, localVarOptionals *BusinessUserServiceApiBusinessUserServiceUpdateUserOpts) (V1UserResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.ParentUserId.IsSet() {
		localVarQueryParams.Add("parent_user_id", parameterToString(localVarOptionals.ParentUserId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/json"}
