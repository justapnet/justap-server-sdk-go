...
> V1ChargeResponse ChargeServiceReverseCharge(ctx, chargeId, optional)
撤销 Charge 对象
 ...
 **optional** | ***DefaultApiChargeServiceReverseChargeOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a DefaultApiChargeServiceReverseChargeOpts struct
...
> V1ChargeResponse ChargeServiceReverseCharge2(ctx, chargeId, optional)
撤销 Charge 对象
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **chargeId** | **string**| Charge 对象 id | 
 **optional** | ***DefaultApiChargeServiceReverseCharge2Opts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a DefaultApiChargeServiceReverseCharge2Opts struct
