...
------------ | ------------- | ------------- | -------------
**AuthToken** | **string** | 授权码 | [optional] [default to null]
**BusinessParams** | **string** | 业务扩展参数 | [optional] [default to null]
...
**PayUrl** | **string** | [ONLY IN RESPONSE] 支付链接 | [optional] [default to null]
**ProductCode** | **string** | 销售产品码 | [optional] [default to null]
**PromoParams** | **string** | 优惠参数 | [optional] [default to null]
**QuitUrl** | **string** | 支付取消跳转的地址 | [optional] [default to null]
**ReturnUrl** | **string** | 支付成功跳转的地址 | [optional] [default to null]
**SellerId** | **string** | [ONLY IN RESPONSE] 收款支付宝用户ID | [optional] [default to null]
