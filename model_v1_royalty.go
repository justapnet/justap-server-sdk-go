...
type V1Royalty struct {
	...
	PayerAppId string `json:"payer_app_id,omitempty"`
	PayerSettleAccountId string `json:"payer_settle_account_id,omitempty"`
	...
	TimeSettled string `json:"time_settled,omitempty"`
}
