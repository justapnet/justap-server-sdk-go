...
const (
	TYPE_UNSET SettlementAccountRecipientRecipientType = "TYPE_UNSET"
	B2_C SettlementAccountRecipientRecipientType = "B2C"
	B2_B SettlementAccountRecipientRecipientType = "B2B"
)
