...
type V1ExtraAlipayPage struct {
	// 业务扩展参数
	BusinessParams float32 `json:"business_params,omitempty"`
	// 禁用渠道
	...
	// 支付宝用户ID
	IntegrationType float32 `json:"integration_type,omitempty"`
	// 发票信息
	...
	// 二维码宽度
	QrcodeWidth float32 `json:"qrcode_width,omitempty"`
	// 请求来源地址
	RequestFromUrl float32 `json:"request_from_url,omitempty"`
